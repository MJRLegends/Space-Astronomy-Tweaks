...
public class WorldGenMinableCustom extends WorldGenerator {
	...
	public WorldGenMinableCustom(IBlockState state, int blockCount) {
		this(state, blockCount, BlockMatcher.forBlock(Blocks.END_STONE));
	}

	public WorldGenMinableCustom(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_) {
		this.oreBlock = state;
